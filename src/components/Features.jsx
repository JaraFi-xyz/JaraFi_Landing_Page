...
//       <div className="mx-auto px-11 py-16">
//         <div className="flex justify-center mb-10">
//           <h2 className="text-3xl font-bold text-neutral-100">
//             Features <span className="inline-block ml-2 w-4 h-4 rounded-full bg-[yellow]"></span>
//           </h2>
//         </div>
...
//                 </h3>
//                 <p className="text-[white] mb-20">{feature.description}</p>
//                 <div className="flex items-center space-x-4 mt-16 mb-20">
//                   <div className="w-16 h-16 rounded-full bg-white text-[#0a0033] flex items-center justify-center text-2xl font-bold ">
//                     {feature.id}
//                   </div>
//                   <div className="flex">
//                     <img 
